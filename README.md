...
<img src="https://raw.githubusercontent.com/alianisreyesr/alianisreyesr/main/assets/profile-header.svg" width="100%" alt="Alianis Reyes-Reyes - Data Engineering, Quality and IT Systems" />
...
| Work | Outcome | Focus |
|---|---|---|
| **Tech@Lilly Hackathon - Most Innovative Solution** | Agentic document-comparison prototype that surfaces gaps, conflicts and duplication between baseline and site procedures. | AI evaluation · reviewer workflow · document intelligence |
| **Student Assembly Registration System** | Full-stack architecture and backend for role-based, passwordless institutional validation, replacing paper-based assembly check-in. | PHP · MySQL · REST/AJAX · access control |
| **Visitor Registration System** | Local full-stack check-in system with admin search, filtering and export, replacing a paper process. | PHP · MySQL · JavaScript |
...
[LinkedIn](https://www.linkedin.com/in/alianis-reyes-reyes/) · [Digital portfolio](https://poplme.co/hash/aJvjFE0Z/1/es) · [Repositories](https://github.com/alianisreyesr?tab=repositories)
